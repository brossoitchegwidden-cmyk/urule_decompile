...
public class RuleParserParser extends Parser {
   ...
   protected static final PredictionContextCache b = new PredictionContextCache();
   ...
   public static final String[] ruleNames = a();
   private static final String[] c = b();
   private static final String[] d = c();
   public static final Vocabulary VOCABULARY = new VocabularyImpl(c, d);
   @Deprecated
   public static final String[] tokenNames = new String[d.length];
   ...
   public RuleParserParser(TokenStream var1) {
      super(var1);
      this._interp = new ParserATNSimulator(this, _ATN, a, b);
   }
      ...
      try {
         ...
         switch (((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 6, this._ctx)) {
            case 1:
               ...
               for (int var13 = this._input.LA(1); (var13 & -64) == 0 && (1L << var13 & 480L) != 0L; var13 = this._input.LA(1)) {
                  this.setState(143);
                  this.resource();
                  this.setState(148);
                  this._errHandler.sync(this);
            ...
            case 2:
               ...
               for (int var12 = this._input.LA(1); var12 == 1; var12 = this._input.LA(1)) {
                  this.setState(149);
                  this.functionImport();
                  this.setState(154);
                  this._errHandler.sync(this);
            ...
            case 3:
               ...
               for (int var10 = this._input.LA(1); (var10 & -64) == 0 && (1L << var10 & 480L) != 0L; var10 = this._input.LA(1)) {
                  this.setState(155);
                  this.resource();
                  this.setState(160);
                  this._errHandler.sync(this);
               ...
               for (int var11 = this._input.LA(1); var11 == 1; var11 = this._input.LA(1)) {
                  this.setState(161);
                  this.functionImport();
                  this.setState(166);
                  this._errHandler.sync(this);
            ...
            case 4:
               ...
               for (int var2 = this._input.LA(1); var2 == 1; var2 = this._input.LA(1)) {
                  this.setState(167);
                  this.functionImport();
                  this.setState(172);
                  this._errHandler.sync(this);
               ...
               for (int var9 = this._input.LA(1); (var9 & -64) == 0 && (1L << var9 & 480L) != 0L; var9 = this._input.LA(1)) {
                  this.setState(173);
                  this.resource();
                  this.setState(178);
                  this._errHandler.sync(this);
   ...
   private RuleParserParser$PackageDefContext a(int var1) throws RecognitionException {
      ...
      try {
         ...
         for (int var13 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 12, this._ctx);
            var13 != 2 && var13 != 0;
            var13 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 12, this._ctx)
         ) {
            if (var13 == 1) {
   ...
   public final RuleParserParser$RuleDefContext ruleDef() throws RecognitionException {
      ...
      try {
         ...
         for (int var9 = this._input.LA(1); (var9 & -64) == 0 && (1L << var9 & 4503598956281856L) != 0L; var9 = this._input.LA(1)) {
            this.setState(266);
            this.attribute();
            this.setState(271);
            this._errHandler.sync(this);
   ...
   public final RuleParserParser$LoopStartContext loopStart() throws RecognitionException {
      ...
      try {
         ...
         for (int var9 = this._input.LA(1); (var9 - 61 & -64) == 0 && (1L << var9 - 61 & 34359738399L) != 0L; var9 = this._input.LA(1)) {
            this.setState(317);
            this.action();
            this.setState(322);
            this._errHandler.sync(this);
   ...
   private RuleParserParser$ConditionContext b(int var1) throws RecognitionException {
      ParserRuleContext var2 = this._ctx;
      int var3 = this.getState();
      RuleParserParser$ConditionContext var4 = new RuleParserParser$ConditionContext(this._ctx, var3);
      byte var6 = 64;
      this.enterRecursionRule(var4, 64, 32, var1);
      ...
      try {
         ...
         switch (((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 48, this._ctx)) {
            case 1:
               var4 = new RuleParserParser$ParenConditionsContext(var4);
               this._ctx = var4;
               this.setState(407);
               this.leftParen();
               this.setState(408);
               ...
               break;
            case 2:
               var4 = new RuleParserParser$SingleConditionContext(var4);
               this._ctx = var4;
               this.setState(412);
               this._errHandler.sync(this);
            ...
            case 3:
               var4 = new RuleParserParser$SingleNamedConditionSetContext(var4);
               this._ctx = var4;
               this.setState(421);
         ...
         for (int var8 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 50, this._ctx);
            var8 != 2 && var8 != 0;
            var8 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 50, this._ctx)
         ) {
            if (var8 == 1) {
               if (this._parseListeners != null) {
                  this.triggerExitRuleEvent();
               ...
               this.pushNewRecursionContext(var4, var6, 32);
               this.setState(424);
   ...
   private RuleParserParser$NamedConditionContext c(int var1) throws RecognitionException {
      ParserRuleContext var2 = this._ctx;
      int var3 = this.getState();
      RuleParserParser$NamedConditionContext var4 = new RuleParserParser$NamedConditionContext(this._ctx, var3);
      byte var6 = 68;
      this.enterRecursionRule(var4, 68, 34, var1);
      ...
      try {
         ...
         switch (this._input.LA(1)) {
            case 10:
               var4 = new RuleParserParser$ParenNamedConditionsContext(var4);
               this._ctx = var4;
               this.setState(448);
               this.leftParen();
               this.setState(449);
               ...
               break;
            case 96:
               var4 = new RuleParserParser$SingleNamedConditionsContext(var4);
               this._ctx = var4;
               this.setState(452);
               this.property();
               this.setState(453);
         ...
         for (int var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 55, this._ctx);
            var7 != 2 && var7 != 0;
            var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 55, this._ctx)
         ) {
            if (var7 == 1) {
               if (this._parseListeners != null) {
                  this.triggerExitRuleEvent();
               ...
               this.pushNewRecursionContext(var4, var6, 34);
               this.setState(460);
   ...
   private RuleParserParser$DecisionTableCellConditionContext d(int var1) throws RecognitionException {
      ParserRuleContext var2 = this._ctx;
      int var3 = this.getState();
      RuleParserParser$DecisionTableCellConditionContext var4 = new RuleParserParser$DecisionTableCellConditionContext(this._ctx, var3);
      byte var6 = 70;
      ...
      try {
         ...
         switch (this._input.LA(1)) {
            case 10:
               var4 = new RuleParserParser$ParenCellConditionsContext(var4);
               this._ctx = var4;
               this.setState(479);
               this.leftParen();
               this.setState(480);
            ...
            case 91:
            case 92:
               var4 = new RuleParserParser$SingleCellConditionContext(var4);
               this._ctx = var4;
               this.setState(474);
               this.op();
               this.setState(477);
         ...
         for (int var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 59, this._ctx);
            var7 != 2 && var7 != 0;
            var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 59, this._ctx)
         ) {
            if (var7 == 1) {
               if (this._parseListeners != null) {
                  this.triggerExitRuleEvent();
               ...
               this.pushNewRecursionContext(var4, var6, 35);
               this.setState(485);
               if (!this.precpred(this._ctx, 2)) {
                  throw new FailedPredicateException(this, "precpred(_ctx, 2)");
               }
   ...
   private RuleParserParser$ExprConditionContext e(int var1) throws RecognitionException {
      ...
      try {
         ...
         for (int var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 66, this._ctx);
            var7 != 2 && var7 != 0;
            var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 66, this._ctx)
         ) {
            if (var7 == 1) {
               if (this._parseListeners != null) {
                  this.triggerExitRuleEvent();
   ...
   public final RuleParserParser$ExpressionBodyContext expressionBody() throws RecognitionException {
      ...
      try {
         ...
         for (int var2 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 67, this._ctx);
            var2 != 1 && var2 != 0;
            var2 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 67, this._ctx)
         ) {
            if (var2 == 2) {
               this.setState(549);
               this.matchWildcard();
   ...
   private RuleParserParser$ComplexValueContext f(int var1) throws RecognitionException {
      ...
      try {
         ...
         for (int var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 83, this._ctx);
            var7 != 2 && var7 != 0;
            var7 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 83, this._ctx)
         ) {
            if (var7 == 1) {
               if (this._parseListeners != null) {
                  this.triggerExitRuleEvent();
   ...
   public final RuleParserParser$PropertyContext property() throws RecognitionException {
      ...
      try {
         ...
         for (int var2 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 84, this._ctx);
            var2 != 2 && var2 != 0;
            var2 = ((ParserATNSimulator)this.getInterpreter()).adaptivePredict(this._input, 84, this._ctx)
         ) {
            if (var2 == 1) {
               this.setState(695);
               this.match(3);
   ...
   static {
      ...
      for (int var1 = 0; var1 < _ATN.getNumberOfDecisions(); var1++) {
         a[var1] = new DFA(_ATN.getDecisionState(var1), var1);
      }
   }
}
