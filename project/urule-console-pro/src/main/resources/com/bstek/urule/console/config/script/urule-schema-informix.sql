...
(
    ...
    CREATE_DATE_         DATETIME year to second  default current year to second not null,      -- 新建日期
    UPDATE_DATE_         DATETIME year to second  default current year to second not null,      -- 更新日期
...
create table URULE_PACKET_APPLY(
	...
	CREATE_USER_	VARCHAR(255),												-- 创建人
    CREATE_DATE_         DATETIME year to second  default current year to second  not null,     -- 新建日期
    UPDATE_DATE_         DATETIME year to second  default current year to second  not null     -- 修改日期
);
...
(
    ...
    CREATE_USER_	VARCHAR(255),										-- 文件创建人
    UPDATE_USER_	VARCHAR(255),										-- 文件更新人
    CREATE_DATE_         DATETIME year to second  default current year to second not null, -- 创建日期
    UPDATE_DATE_         DATETIME year to second  default current year to second not null -- 更新日期
);
...
(
    ...
    EXPIR_DATE_         DATETIME year to second  default current year to second 	 null,  -- 密码找回过期时间
    CREATE_DATE_         DATETIME year to second  default current year to second not null,  -- 新建日期
    UPDATE_DATE_         DATETIME year to second  default current year to second not null  -- 更新日期
);
...
(
    ...
    CREATE_DATE_    DATETIME year to second  default current year to second not null,  -- 加入日期
    PRIMARY KEY (ID_)
);
...
(
    ...
    EXPIR_DATE_     DATETIME year to second  default current year to second  null,  -- 过期时间
    CREATE_USER_	VARCHAR(255),									-- 创建人
    CREATE_DATE_    DATETIME year to second  default current year to second  null  -- 创建日期
);
...
(
    ...
    AUTH_ 			SMALLINT          default 1  not null -- 授权信息
);
...
(
    ...
    CREATE_DATE_    DATETIME year to second  default current year to second  null  -- 创建时间
);
...
(
    ...
    START_TIME_     DATETIME year to second  default current year to second  null,  -- 调用开始时间
    END_TIME_     	DATETIME year to second  default current year to second  null,  -- 调用结束时间
    TIME_			INT			                 	null, -- 耗时
    GROUP_ID_ 		VARCHAR(50)					not null, -- 团队编号
    GROUP_NAME_ 	VARCHAR(255)					null, -- 团队名称
   	PROJECT_ID_ 	INT							not null, -- 项目编号
