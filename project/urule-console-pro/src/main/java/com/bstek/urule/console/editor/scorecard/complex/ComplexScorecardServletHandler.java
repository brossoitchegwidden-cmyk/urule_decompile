...
public class ComplexScorecardServletHandler extends ApiServletHandler {
   public void excel(HttpServletRequest var1, HttpServletResponse var2) throws Exception {
      ...
      var3.close();
      ComplexScoreTableBuilder var6 = new ComplexScoreTableBuilder(var5);
      ComplexScorecardDefinition var7 = var6.buildTable();
      this.a(var2, var7);
   }
   ...
   public void doExport(HttpServletRequest var1, HttpServletResponse var2) throws Exception {
      ...
      ComplexScorecardExcelBuilder var7 = new ComplexScorecardExcelBuilder();
      ComplexScorecardDefinition var8 = var7.buildTable(var5);
   ...
   private ScoreTableData a(XSSFSheet var1) throws Exception {
         ...
         for(int var11 = 0; var11 < var5.size(); ++var11) {
            ...
            if (var12 != null) {
               ...
               if (var13 != 0) {
                  ...
                  XSSFComment var16 = var12.getCellComment();
                  if (var16 != null) {
                     String var17 = var16.getString().toString().toLowerCase().trim();
                     var15.setProperty(var17);
                  }

                  var15.setHeader(var14);
                  CellType var19 = var12.getCellTypeEnum();
                  switch (var19) {
                     case STRING:
      ...
      ScoreTableData var18 = new ScoreTableData(var5, var2);
      var18.setProperties(var6);
      return var18;
   }
