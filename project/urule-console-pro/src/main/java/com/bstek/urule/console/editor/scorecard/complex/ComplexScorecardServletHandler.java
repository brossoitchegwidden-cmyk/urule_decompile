...
public class ComplexScorecardServletHandler extends ApiServletHandler {
   public void excel(HttpServletRequest req, HttpServletResponse resp) throws Exception {
      ...
      inputStream.close();
      ComplexScoreTableBuilder complexScoreTableBuilder = new ComplexScoreTableBuilder(scoreTableData);
      ComplexScorecardDefinition table = complexScoreTableBuilder.buildTable();
   ...
   public void doExport(HttpServletRequest req, HttpServletResponse resp) throws Exception {
      ...
      ComplexScorecardExcelBuilder complexScorecardExcelBuilder = new ComplexScorecardExcelBuilder();
      ComplexScorecardDefinition table = complexScorecardExcelBuilder.buildTable(ruleFile);
      ...
      complexScorecardExcelBuilder.buildExcel(table, outputStream);
      outputStream.flush();
      outputStream.close();
   }
            ...
            if (cell != null) {
               ...
               if (number != 0) {
                  ...
                  if (cellComment != null) {
                     ...
                     cellData.setProperty(trimmedText);
                  }
